...
- [x] SPEC-017: CI/CD (infraestrutura/Terraform) — Implementado (Makefile em sub-alvos + infra-bootstrap.yml); validado 2026-09-24, 5/5 critérios (subagent independente: 3 jobs reais na ordem certa, idempotência via terraform plan + images-eks, ponta a ponta confirmada no cluster)
